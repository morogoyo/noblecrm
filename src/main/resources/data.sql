...
insert into user_info (fname,lname,job_title,address,city,state,zip,birth_day,company_name,demographic_info,lead_source,marital_status,number_of_children,id,email)
values ("Rene","Torres","Software Engineer","123 main st.","Orlando","Florida",12345,
        "10-11-1979","noble digital","hispanic","sales funnel","maried",4,1,"morogoyo@gmail.com"
       );

insert into noble.client_assets (adminurl,id,email,services,siteurl)
values ("nobledigitalservices.com/admin",1,"morogoyo@gmail.com","webServices","nobledigitalservices.com"
       );
